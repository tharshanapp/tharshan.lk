...
ADMIN_TOKEN = os.getenv("ADMIN_TOKEN", "change_this_secure_token_123")
CORS_ORIGINS = os.getenv("CORS_ORIGINS", "http://localhost:3000,http://localhost:8000,https://tharshan.lk").split(",")
