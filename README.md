...
A production-ready, full-stack RAG (Retrieval Augmented Generation) AI web application designed for Sri Lankan government officers to query Financial Regulations (FR), Procurement Guidelines, and Establishment Codes (ECode) using natural language.
